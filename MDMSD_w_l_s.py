...
def main(y, dy, Ly, layer_width, ind_big):
    ...
    for i in range(0, N_dt):
        ...
        if (len(y_input) != 0):
            ...
            temp, temp_l, temp_s = post_species_MSD_y_wo_correction(pre_MSD_l, pre_MSD_s, pre_MSD_l_dy_mean, pre_MSD_s_dy_mean, Ly)
...
def post_species_MSD_y_wo_correction(preMSD_l, preMSD_s, preMSD_l_dy_mean, preMSD_s_dy_mean, Ly):
    output = []    
    output_l = []
    output_s = []    
